...
def build_train_valid_test_datasets(data_prefix, data_impl, splits_string,
    ...
    def build_dataset(index, name):
        ...
        if splits[index + 1] > splits[index]:
            ...
            dataset = SegaGPT2Dataset(name, data_prefix,
...
class SegaGPT2Dataset(torch.utils.data.Dataset):
    #TODO: @ruixue support return {'text': np.array(sample, dtype=np.int64),
    # 'token_position_ids': np.array(？,dtype=np.int64),
    # 'sent_position_ids': np.array(？,dtype=np.int64),
    # 'para_position_ids': np.array(？,dtype=np.int64),}
    ...
    def __getitem__(self, idx):
        ...
        # TODO: self.token_indexed_dataset.get
